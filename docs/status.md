...
Release-candidate code and validation are complete:

- Plugin architecture and normalized findings
- Read-only system, network, update, and event diagnostics
- JSON, CSV, and HTML case evidence
